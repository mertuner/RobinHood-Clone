...
export const stockData = [
    {
        ...
        {
            description: 
oneLine`SPY tracks a market-cap-weighted index of US large- and midcap stocks selected by the S&P Committee. The listed name for SPY is SPDR S&P 500 ETF Trust.`
        }
    },
    {
        ticker: 'AAPL',
        ...
        news: [
            ...
            {
                datetime: '2h',
                headline: "Apple faces patent lawsuit over iPhone security tools: Report",
                source: "Benzinga",
                url: "https://cloud.iexapis.com/v1/news/article/2ki8C27e7Imf4XXgX9ASto0FoPMSpp9BnVmfU2YLoaKZ",
                ...
                related: "AAPL",
                image: "https://cloud.iexapis.com/v1/news/image/2ki8C27e7Imf4XXgX9ASto0FoPMSpp9BnVmfU2YLoaKZ",
                lang: "en",
            },
            {
                datetime: '3h',
        ...
        analystRatings: {
            ...
            sell: '5',
            number: '44',
            bullsSay: `Between greater smartphone penetration in emerging markets and repeat sales to current customers, Apple has plenty of opportunity to reap the rewards of its iPhone business.
            ...
            `,
            bearsSay: `Apple’s decisions to maintain a premium pricing strategy may help fend off gross margin compression but could limit unit sales growth, as devices may be unaffordable for many customers.
        ...
        about: {
            description: 
oneLine`Apple, Inc. engages in the design, manufacture, and sale of smartphones, personal 
...
Cupertino, CA. The listed name for AAPL is Apple Inc. Common Stock.`,
    ...
    },
    {
        ...
        analystRatings: {
            ...
            sell: '5',
            number: '41',
            bullsSay: `The firm has a first-mover advantage in the autonomous driving market that could lead to widespread adoption of its Drive PX self-driving platform.
            ...
            bearsSay: `The artificial intelligence opportunity remains nascent and it is not a foregone conclusion for Nvidia's GPUs to dominate.
        ...
        about: {
            description: 
oneLine`NVIDIA Corp. engages in the design and manufacture of computer graphics
...
The listed name for NVDA is NVIDIA Corporation Common Stock.`,
    ...
    },
    {
        ...
        analystRatings: {
            ...
            sell: '2',
            number: '41',
            bullsSay: `Uber’s position in the autonomous vehicle race could equalize gross and net revenue, after no longer needing to pay drivers.
            ...
            bearsSay: `Uber’s public perception has suffered in recent years because of data breaches and bad culture of sexual misconduct and internal racial discrimination issues.
            ...
            The development of autonomous vehicles, and especially Google’s Waymo, could eliminate the need for all existing ride-share platforms, driving Uber and Lyft out of business.`
        },
        earnings: {
            expectedInOrder: [
                '-1.02',
        ...
        about: {
            description: 
oneLine`Uber Technologies, Inc. operates as a technology platform for people and things mobility. 
...
Uber Technologies, Inc.`,
    ...
    },
    {
        ...
        about: {
            description: 
oneLine`GameStop Corp. engages in the retail of multichannel video game, 
...
GME is GameStop Corp. Class A.`,
    ...
    },
    {
        ...
        analystRatings: {
            ...
            sell: '21',
            number: '39',
            bullsSay: `Tesla has the potential to disrupt the automotive and power generation industries with its technology for EVs, AVs, batteries, and solar generation systems.
            ...
            `,
            bearsSay: `Traditional automakers are investing heavily in the development of electric vehicles, which will result in Tesla losing market share and seeing a deceleration in sales growth due to increased competition.
        ...
        about: {
            description: 
oneLine`Tesla, Inc. engages in the design, development, manufacture, and sale of fully electric vehicles, 
